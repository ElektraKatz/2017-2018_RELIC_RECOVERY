...
/**
 * Created by LZTDD0 on 10/26/2016.
 * Originally from
...
public class MultiplexAdaFruitColorSensor {
     ...
     */
    public MultiplexAdaFruitColorSensor(HardwareMap hardwareMap,
                                        String muxName,
                                        String colorName,
                                        int[] ports,
                                        double milliSeconds,
